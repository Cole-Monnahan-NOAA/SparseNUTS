...
#> Average run time per chain was 2.11 seconds 
...
#> 
#> 
#>  Elapsed Time: 0.151 seconds (Warm-up)
...
#> 1 chain(s) of 1150 total iterations (150 warmup) were used
#> Average run time per chain was 1 seconds 
...
#> 
#> 
#>  Elapsed Time: 2.615 seconds (Warm-up)
#>                1.884 seconds (Sampling)
#>                4.499 seconds (Total)
#> 
#> 
#> 
...
#> Average run time per chain was 4.5 seconds 
...
#> 
#> 
#>  Elapsed Time: 11.553 seconds (Warm-up)
#>                3.82 seconds (Sampling)
#>                15.373 seconds (Total)
#> Warning: The ESS has been capped to avoid unstable estimates.
#> Warning: The ESS has been capped to avoid unstable estimates.
#> Warning: The ESS has been capped to avoid unstable estimates.
#> Warning: The ESS has been capped to avoid unstable estimates.
...
#> 1 chain(s) of 2000 total iterations (1000 warmup) were used
#> Average run time per chain was 15.37 seconds 
...
#> 
#> 
#>  Elapsed Time: 0.957 seconds (Warm-up)
#>                5.89 seconds (Sampling)
#>                6.847 seconds (Total)
#> 
#> 
#> 
...
#> 1 chain(s) of 1150 total iterations (150 warmup) were used
#> Average run time per chain was 6.85 seconds 
#> Minimum ESS=628.4 (62.84%), and maximum Rhat=1.003
#> There were 0 divergences after warmup
```
...
#> Chain 4:  Elapsed Time: 1.468 seconds (Warm-up)
#> Chain 4:                6.856 seconds (Sampling)
#> Chain 4:                8.324 seconds (Total)
#> Chain 2:  Elapsed Time: 3.972 seconds (Warm-up)
#> Chain 2:                9.965 seconds (Sampling)
#> Chain 2:                13.937 seconds (Total)
#> Chain 1:  Elapsed Time: 1.511 seconds (Warm-up)
#> Chain 1:                14.548 seconds (Sampling)
#> Chain 1:                16.059 seconds (Total)
#> Chain 3:  Elapsed Time: 1.089 seconds (Warm-up)
#> Chain 3:                20.297 seconds (Sampling)
#> Chain 3:                21.386 seconds (Total)
#> 
#> 
#> Model 'RTMB' has 10 pars, and was fit using NUTS with a 'diag' metric
#> 4 chain(s) of 1150 total iterations (150 warmup) were used
#> Average run time per chain was 14.93 seconds 
...
#> Starting MCMC sampling...
#> Preparing parallel workspace...
#> Chain 1: Gradient evaluation took 0.048345 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 483.45 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 2: Gradient evaluation took 0.034695 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 346.95 seconds.
#> Chain 2: Adjust your expectations accordingly!
#> Chain 3: Gradient evaluation took 0.029557 seconds
#> Chain 3: 1000 transitions using 10 leapfrog steps per transition would take 295.57 seconds.
#> Chain 3: Adjust your expectations accordingly!
#> Chain 4: Gradient evaluation took 0.043326 seconds
#> Chain 4: 1000 transitions using 10 leapfrog steps per transition would take 433.26 seconds.
#> Chain 4: Adjust your expectations accordingly!
#> Chain 1:  Elapsed Time: 0.58 seconds (Warm-up)
#> Chain 1:                3.105 seconds (Sampling)
#> Chain 1:                3.685 seconds (Total)
#> Chain 3:  Elapsed Time: 0.594 seconds (Warm-up)
#> Chain 3:                2.836 seconds (Sampling)
#> Chain 3:                3.43 seconds (Total)
#> Chain 4:  Elapsed Time: 0.617 seconds (Warm-up)
#> Chain 4:                2.695 seconds (Sampling)
#> Chain 4:                3.312 seconds (Total)
#> Chain 2:  Elapsed Time: 0.762 seconds (Warm-up)
#> Chain 2:                2.989 seconds (Sampling)
#> Chain 2:                3.751 seconds (Total)
#> 
#> 
#> Model 'RTMB' has 1 pars, and was fit using NUTS with a 'diag' metric
#> 4 chain(s) of 1150 total iterations (150 warmup) were used
#> Average run time per chain was 3.54 seconds 
...
#>               2       8.084e+01      3.600e+01   4.441e-15    1.000e+00  1.000e+00        62 -4.664e+01 -1.453e+21                  
#> Path [1] :Best Iter: [1] ELBO (-46.635493) evaluations: (62)
#> Path [2] :Initial log joint density = -10.287998
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes 
#>               2       8.084e+01      3.600e+01   4.441e-15    1.000e+00  1.000e+00        62 -4.613e+01 -1.030e+20                  
#> Path [2] :Best Iter: [1] ELBO (-46.126750) evaluations: (62)
#> Path [3] :Initial log joint density = -10.287998
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes 
#>               2       8.084e+01      3.600e+01   4.441e-15    1.000e+00  1.000e+00        62 -3.778e+01 -1.556e+20                  
#> Path [3] :Best Iter: [1] ELBO (-37.783265) evaluations: (62)
#> Path [4] :Initial log joint density = -10.287998
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes 
#>               2       8.084e+01      3.600e+01   4.441e-15    1.000e+00  1.000e+00        62 -3.682e+01 -3.792e+20                  
#> Path [4] :Best Iter: [1] ELBO (-36.817454) evaluations: (62)
